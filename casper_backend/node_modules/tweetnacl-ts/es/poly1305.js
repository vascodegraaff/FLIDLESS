...
export function poly1305_init(key) {
    var r = HalfArray(10);
    var pad = HalfArray(8);
...
;
export function poly1305_blocks(self, m, mpos, bytes) {
...
;
export function poly1305_finish(self, mac, macpos) {
    var g = HalfArray(10);
    var c, mask, f, i;
...
;
export function poly1305_update(self, m, mpos, bytes) {
    var i, want;
