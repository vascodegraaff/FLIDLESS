...
function hash(msg) {
    check_1.checkArrayTypes(msg);
    var h = array_1.ByteArray(64 /* Hash */);
    _hash(h, msg, msg.length);
    return h;
}
exports.hash = hash;
function _hash(out, m, n) {
    var hh = array_1.IntArray(8), hl = array_1.IntArray(8), x = array_1.ByteArray(256);
    var i, b = n;
    hh[0] = 0x6a09e667;
    hh[1] = 0xbb67ae85;
    hh[2] = 0x3c6ef372;
...
function _hashblocks_hl(hh, hl, m, n) {
    var wh = array_1.IntArray(16), wl = array_1.IntArray(16);
