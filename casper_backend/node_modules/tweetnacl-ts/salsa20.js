...
exports._sigma = array_1.ByteArray([101, 120, 112, 97, 110, 100, 32, 51, 50, 45, 98, 121, 116, 101, 32, 107]);
// "expand 32-byte k"
function _stream_salsa20_xor(c, cpos, m, mpos, b, n, k) {
    var z = array_1.ByteArray(16), x = array_1.ByteArray(64);
    var u, i;
    for (i = 0; i < 16; i++)
        z[i] = 0;
    for (i = 0; i < 8; i++)
...
function _stream(c, cpos, d, n, k) {
    var s = array_1.ByteArray(32), sn = array_1.ByteArray(8);
